 ...
 */?>
        ...
        <div class="col-md-9">
            ...
            <form action="<?php echo base_url();?>Accident/service_center_insert_to_db" method="post">
                <div class="form-horizontal">
                    <div class="panel panel-info">
                        <div class="panel-heading" style="font-size: large">Add Service Centers</div>
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" style="font-size: medium;">Contact Person</label>
                                <div class="col-md-5 ">
                                    <?php
                                    $input_data3 = array(
                                        'name'  => 'sc_contact_person',
                                        'class' => 'form-control'
                                    );
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" style="font-size: medium;">Contact Person Title</label>
                                <div class="col-md-5 ">
                                    <?php
                                    $input_data4 = array(
                                        'name'  => 'sc_title',
