 ...
 */?>
        ...
        <div class="col-md-9">
            ...
            <form action="<?php echo base_url();?>Minister/minister_designation_insert_to_db" method="post">
                <div class="form-horizontal">
                    <div class="panel panel-info">
                        <div class="panel-heading" style="font-size: large">Add Minister Designation</div>
