...
?>
        ...
        <div class="col-md-9">
            ...
            <form action="<?php echo base_url();?>Registered_institution/registered_institution_insert_to_db" method="post">
                <div class="form-horizontal">
                    <div class="panel panel-info">
                        <div class="panel-heading" style="font-size: large">Add Registered Institution</div>
